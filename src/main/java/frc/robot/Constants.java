...
public final class Constants {
  ...
  public static final class AutoAlignConstants { // Also for driving to pose in general.
    ...
    public static final double kEndWaypointSpeed = 0.3;
    public static final double kSharedNotePickUpDist = 1.5;
    public static final Pose2d kBottomSharedNotePickUpPose =
        new Pose2d(
            kCenterNoteB.getX() - kSharedNotePickUpDist, kCenterNoteB.getY(), new Rotation2d(0));
